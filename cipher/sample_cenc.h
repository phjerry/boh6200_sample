...
#define MAX_SUBSAMPLE_CNT        20
#define MAX_SUBSAMPLE_DATA_LEN   1024

typedef struct
{
    hi_u8 enc[MAX_SUBSAMPLE_DATA_LEN];
    hi_u8 dec[MAX_SUBSAMPLE_DATA_LEN];
    hi_u8 key[16];
    hi_u8 iv[16];
    hi_unf_cipher_alg alg;
    hi_unf_cipher_work_mode mode;
    hi_u32 length;
    hi_u32 first_encrypt_offset;
    hi_u32 subsample_num;
    hi_unf_cipher_subsample subsample[MAX_SUBSAMPLE_CNT];
}cenc_gold_s;
...
static cenc_gold_s cenc_sample_data[] =
{
    {//sample 0
        ...
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 400, 0, 1, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
    ...
    {//sample 2
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CBC, 176, 0, 1, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
    ...
    {//sample 3, last block <> 16,
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CBC, 183, 0, 1, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
    ...
    {//sample 4, 3 subsample,
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CBC, 14 * 16 + 12 + 24, 0, 3, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
            /* clear,  payload,    encrypt,    skip,       offset */
    ...
    {//sample 5, 3 subsample,
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CBC, 14 * 16 + 12 + 14, 0, 3, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
            /* clear,  payload,    encrypt,    skip,       offset */
            {  0, 0x01 * 16 + 7,  0x02 * 16,  0x01 * 16,  0x01 * 16, HI_TRUE, {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},// 0 | E16 | 7
    ...
    {//sample 7
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CBC, 180, 0, 1, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
            /* clear,  payload,    encrypt,    skip,       offset */
    ...
    {//sample 8
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 676, 0, 3, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
            /* clear size, payload size, encrypt, skip, offset */
    ...
    {//sample 9
        ...
        {//subsample,
            ...
            {0x19, 0xa0,  0x03 * 16, 0x07 * 16, 0x06 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
        }
    },
    {//sample 10, line 3904
        {//enc
        ...
        {//subsample,
            ...
            {0x19,         0xA0,         0x07 * 16, 0x02 * 16, 0x07 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
        },
    },
    {//sample 11, line 6126, sub[1] block_offset size:0x8
        ...
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 165, 0, 3, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
    ...
    {//sample 14, line 6126, iv no changes in sub 0
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0 }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 165, 2, 3, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
    ...
    {//sample 15
        ...
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 40, 0, 2, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
    ...
    {//sample 16
        ...
        { 0xB8, 0x35, 0x49, 0xE6, 0xAD, 0xD7, 0x1A, 0x3A, 0x9D, 0x7D, 0x22, 0x76, 0x1B, 0x7B, 0xCE, 0x0A }, //key
        { 0x6a, 0x44, 0x2a, 0x8d, 0xd2, 0xa7, 0x68, 0xd4, 0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0 }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 8, 0, 1, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
            {0x00,         0x08,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE,  {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
        }
    ...
    {//sample 17
        ...
        { 0xB8, 0x35, 0x49, 0xE6, 0xAD, 0xD7, 0x1A, 0x3A, 0x9D, 0x7D, 0x22, 0x76, 0x1B, 0x7B, 0xCE, 0x0A }, //key
        { 0x6a, 0x44, 0x2a, 0x8d, 0xd2, 0xa7, 0x68, 0xd4, 0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0 }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 32, 8, 1, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
            {0x00,         0x20,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE,  {0x00000000, 0x00000000, 0x00000000, 0x00000000}},
        }
    ...
    {//sample 18
        ...
        { 0xB8, 0x35, 0x49, 0xE6, 0xAD, 0xD7, 0x1A, 0x3A, 0x9D, 0x7D, 0x22, 0x76, 0x1B, 0x7B, 0xCE, 0x0A }, //key
        { 0x6a, 0x44, 0x2a, 0x8d, 0xd2, 0xa7, 0x68, 0xd4, 0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0 }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 32, 0, 2, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
   ...
   {//sample 21
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 403, 0, 1, //mode, length, first_encrypt_offset, subsample_num
        {//subsample,
    ...
    {//sample 23
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 403, 0, 20, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x10, 0x01, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
            {0x00, 0x01, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
            {0x00, 0x01, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
            {0x00, 0x01, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
            {0x00, 0x01, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
            {0x00, 0x01, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
            ...
            {0x00, 0x01, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
            {0x00, 0x01, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
            {0x00, 0x170, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
        }
    },
    {//sample 24
        {//enc
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 403, 15, 20, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x0F, 0x02, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFDFFFFFF}},
            {0x00, 0x01, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
            {0x00, 0x01, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
            {0x00, 0x01, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
            {0x00, 0x01, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0xFFFFFFFF, 0xFEFFFFFF}},
    ...
    {//sample 25
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CBC, 0x100000, 0, 1, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x00, 0x100000, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x03020100, 0x07060504, 0x07060504, 0x07060504}},
        }
    },
    {//sample 26
        {//enc
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CBC, 0x500000, 0, 5, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x00, 0x100000, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x03020100, 0x07060504, 0x07060504, 0x07060504}},
            {0x00, 0x100000, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x07060504, 0x07060504}},
            {0x00, 0x100000, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x07060504, 0x07060504}},
            {0x00, 0x100000, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x07060504, 0x07060504}},
            {0x00, 0x100000, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x07060504, 0x07060504}},
        }
    ...
    {//sample 27
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 0x100000, 0, 1, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x00, 0x100000, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x03020100, 0x07060504, 0x07060504, 0x07060504}},
        }
    ...
    {//sample 28
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 0x500000, 0, 5, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x00, 0x100000, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x03020100, 0x07060504, 0x07060504, 0x07060504}},
            {0x00, 0x100000, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x07060504, 0x07060504}},
    ...
    {//sample 29
        ...
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 400, 0, 7, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, payload size, encrypt, skip, offset */
            {0x00, 0x10, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
            {0x00, 0x20, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
            {0x00, 0x30, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
            {0x00, 0x40, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
            {0x00, 0x50, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
            {0x00, 0x60, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
            {0x00, 0x40, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
        }
     },
     {//sample 30
        {//enc
            0x6E,0x3A,0x5E,0xA7,0x35,0x41,0x1D,0x47,0x3E,0x52,0x96,0x7F,0x72,0x26,0x85,0x3B,
        },
        {//dec
            0x64,0xB2,0xDB,0x6F,0x94,0x28,0x3D,0xEA,0xF2,0x42,0x4F,0xA6,0x3F,0x17,0xC5,0xAF,
        },
        {0x1A,0xD4,0x0D,0x7D,0xF0,0xD6,0x01,0xAF,0xB2,0xE3,0x86,0xE8,0x3B,0xD9,0xEE,0xB3},//key
        {0x0A,0x2C,0x99,0x8E,0xBF,0x09,0xBB,0x3D,0x00,0x00,0x00,0x00,0x00,0x00,0x03,0xEE},//iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 16, 0, 1, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, payload size, encrypt, skip, offset */
            {0x00, 0x10, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x8E992C0A, 0x3DBB09BF, 0x00000000, 0xEE030000}},
        }
     },
     {//sample 31
        {//enc
        ...
        {//subsample,
            /* clear size, payload size, encrypt, skip, offset */
            {0x190, 0x00, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
        }
    },
    {//sample 32
        {//enc
        ...
        { 0xB8, 0x35, 0x49, 0xE6, 0xAD, 0xD7, 0x1A, 0x3A, 0x9D, 0x7D, 0x22, 0x76, 0x1B, 0x7B, 0xCE, 0x0A }, //key
        { 0x6a, 0x44, 0x2a, 0x8d, 0xd2, 0xa7, 0x68, 0xd4, 0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0 }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 40, 0, 5, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
            {0x00,         0x02,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE,  {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x06,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x03,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x11,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x0C,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
        }
    },
    {//sample 33
        {//enc
        ...
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
            {0x00,         0x02,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE,  {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x12,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x0C,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x07,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x01,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
        }
    },
    {//sample 34
        {//enc
        ...
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
            {0x00,         0x01,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE,  {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x02,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x05,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x12,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x0E,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
        }
    },
    {//sample 35
        {//enc
        ...
        { 0xB8, 0x35, 0x49, 0xE6, 0xAD, 0xD7, 0x1A, 0x3A, 0x9D, 0x7D, 0x22, 0x76, 0x1B, 0x7B, 0xCE, 0x0A }, //key
        { 0x6a, 0x44, 0x2a, 0x8d, 0xd2, 0xa7, 0x68, 0xd4, 0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0 }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 40, 0, 4, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
            {0x00,         0x01,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE,  {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x08,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x10,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x0f,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
        }
    },
    {//sample 36
        {//enc
            0xa5,0xa5,0xa5,0xa5,//head
            0xC7,0x1A,
            0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0x1A,0x34,0x68,0x9D,0x80,0x4E,0x85,0x98,0xBA,0x57,0x7A,0xBD,
            0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,
            0xa5,0xa5,//head
            0xFF,0x25,0x57,0x58,0x92,0x3D,0xAD,0xC8,0x4D,0xFB,0x2C,0x0A,0x1B,0xAD,0xC4,0xE0,
            0xa5,0xa5,//head
            0x87,0x85,0x92,0x8F,0x85,0xE5,0x4C,0xCE,0x6D,0xC4,
        },
        {//dec
            0xa5,0xa5,0xa5,0xa5,//head
            0x47,0x40,
            0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0x00,0x10,0x00,0x00,0xb0,0x0d,0x00,0x01,0xc1,0x00,0x00,0x00,
            0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,
            0xa5,0xa5,//head
            0x0b,0xe1,0x37,0x2f,0xf8,0x5e,0xde,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
            0xa5,0xa5,//head
            0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff
        },
        { 0xB8, 0x35, 0x49, 0xE6, 0xAD, 0xD7, 0x1A, 0x3A, 0x9D, 0x7D, 0x22, 0x76, 0x1B, 0x7B, 0xCE, 0x0A }, //key
        { 0x6a, 0x44, 0x2a, 0x8d, 0xd2, 0xa7, 0x68, 0xd4, 0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0 }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 69, 0, 4, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
            {0x04,         0x02,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x05,         0x0C,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x12,         0x10,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x02,         0x0a,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
        }
    },
    {//sample 37
        {//enc
            0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,
            0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0xC7,0x1A,0x1A,0x34,0x68,0x9D,0x80,0x4E,
            0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0x85,0x98,0xBA,0x57,0x7A,0xBD,
            0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0xFF,0x25,0x57,0x58,0x92,0x3D,0xAD,0xC8,0x4D,0xFB,0x2C,0x0A,0x1B,0xAD,0xC4,0xE0,
            0x87,0x85,0x92,0x8F,0x85,0xE5,0x4C,0xCE,0x6D,0xC4,
        },
        ...
        { 0xB8, 0x35, 0x49, 0xE6, 0xAD, 0xD7, 0x1A, 0x3A, 0x9D, 0x7D, 0x22, 0x76, 0x1B, 0x7B, 0xCE, 0x0A }, //key
        { 0x6a, 0x44, 0x2a, 0x8d, 0xd2, 0xa7, 0x68, 0xd4, 0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0 }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 86, 0, 4, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
            {0x1F,         0x00,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x05,         0x08,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x05,         0x06,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x05,         0x1a,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
        }
    },
    {//sample 38
        {//enc
            ...
            0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0xC7,0x1A,0x1A,0x34,0x68,0x9D,0x80,0x4E,0x85,
            0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0x98,0xBA,0x57,0x7A,0xBD,0xFF,
            0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0x25,0x57,0x58,0x92,0x3D,0xAD,0xC8,0x4D,0xFB,0x2C,0x0A,0x1B,0xAD,0xC4,0xE0,0x87,
            0x85,0x92,0x8F,0x85,0xE5,0x4C,0xCE,0x6D,0xC4,
        },
        {//dec
            0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,
            0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0x47,0x40,0x00,0x10,0x00,0x00,0xb0,0x0d,0x00,
            0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0x01,0xc1,0x00,0x00,0x00,0x0b,
            0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0xe1,0x37,0x2f,0xf8,0x5e,0xde,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
        ...
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
            {0x1F,         0x00,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x05,         0x09,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x05,         0x06,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x05,         0x19,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
        }
    },
    {//sample 39
        {//enc
        ...
        { 0xB8, 0x35, 0x49, 0xE6, 0xAD, 0xD7, 0x1A, 0x3A, 0x9D, 0x7D, 0x22, 0x76, 0x1B, 0x7B, 0xCE, 0x0A }, //key
        { 0x6a, 0x44, 0x2a, 0x8d, 0xd2, 0xa7, 0x68, 0xd4, 0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0 }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 77, 0, 4, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
            {0x1F,         0x00,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x01,         0x08,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x06,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x05,         0x1a,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
        }
    },
    {//sample 40
        {//enc
            ...
            0xa5,0xa5,//head
            0x1A,0x1A,
            0x34,0x68,0x9D, 0x80,0x4E,
            0xa5,0xa5,//head
            0x85,0x98,0xBA,0x57,0x7A,0xBD,0xFF,0x25,0x57,0x58,0x92,0x3D,0xAD,0xC8,0x4D,0xFB,
            0x2C,0x0A,
            0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,
            0xa5,0xa5,//head
            0x1B,0xAD,0xC4,0xE0,0x87,0x85,0x92,0x8F,0x85,0xE5,0x4C,0xCE,0x6D,0xC4,
        },
        {//dec
            0xa5,0xa5,0xa5,0xa5,0xa5,//head
            0x47,
            0xa5,0xa5,//head
            0x40,0x00,
            0x10,0x00,0x00,0xb0,0x0d,
            0xa5,0xa5,//head
            0x00,0x01,0xc1,0x00,0x00,0x00,0x0b,0xe1,0x37,0x2f,0xf8,0x5e,0xde,0xff,0xff,0xff,
            0xff,0xff,
            0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,0xa5,
            0xa5,0xa5,//head
        ...
        { 0xB8, 0x35, 0x49, 0xE6, 0xAD, 0xD7, 0x1A, 0x3A, 0x9D, 0x7D, 0x22, 0x76, 0x1B, 0x7B, 0xCE, 0x0A }, //key
        { 0x6a, 0x44, 0x2a, 0x8d, 0xd2, 0xa7, 0x68, 0xd4, 0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0 }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 67, 0, 5, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, payload size, encrypt,   skip,      offset */
            {0x05,         0x01,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x02,         0x02,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x00,         0x05,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x02,         0x12,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
            {0x12,         0x0e,         0x00 * 16, 0x00 * 16, 0x00 * 16, HI_FALSE, {0x8d2a446a, 0xd468a7d2, 0x00000000, 0x00000000}},
        }
    },
    {//sample 41
        {//enc
        ...
        {//dec
            0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf,
            
        },
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_SM4, HI_UNF_CIPHER_WORK_MODE_CBC, 416, 0, 1, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x10, 0x190, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE,  {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
        }
    },
    {//sample 42
        {//enc
        ...
        {//dec
            0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf,
            
        },
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_SM4, HI_UNF_CIPHER_WORK_MODE_CTR, 416, 0, 1, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, encrypt size, encrypt, skip, offset */
            {0x10, 0x190, 0x00 * 16, 0x00 * 16, 0x00 * 16, HI_TRUE,  {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
        }
    ...
    {//sample 43
        {//enc
            0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf,
            0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x17,0x
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //key
        { 0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf }, //iv
        HI_UNF_CIPHER_ALG_AES, HI_UNF_CIPHER_WORK_MODE_CTR, 676, 0, 3, //mode, length, FirstEncryptOffset, subsampleNum
        {//subsample,
            /* clear size, payload size, encrypt, skip, offset */
            {0x19, 0xa0,  0x03 * 16, 0x07 * 16, 0x00 * 16, HI_TRUE,  {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
            {0x32, 0x100, 0x03 * 16, 0x07 * 16, 0x00 * 16, HI_FALSE, {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c}},
    ...
    {//sample 44
        {//enc
            ...
            0xb8,0xfc,0x80,0x8b,0x9,0x89,0x6f,0xab,0xf,0x4,0x41,0xe0,0x9e,0xd4,0x11,0xd0,
            0x57,0x33,0x71,0x77,0x3c,0x12,0xe3,0x84,0x56,0xd4,0x69,0xaa,0x74,0x1b,0x65,0xd7,
            0x8f,0xb2,0x9a,0xc6,0x41,0x60,0x64,0x64,0x11,//e
            0x69,0x6a,0x6b,0x6c,0x6d,0x6e,0x6f,
            0x70,0x71,0x72,0x73,0x74,0x75,0x76,0x77,0x78,0x79,0x7a,0x7b,0x7c,0x7d,0x7e,0x7f,
            0x80,0x81,0x82,0x83,0x84,0x85,0x86,0x87,0x88,0x89,0x8a,0x8b,0x8c,0x8d,0x8e,0x8f,
            0x90,0x91,0x92,0x93,0x94,0x95,0x96,0x97,0x98,//c
            0x92,0x22,0x9c,0xee,0x3c,0x57,0xb5,
            0x95,0x85,0xc0,0x4e,0x0,0xa2,0xb9,0x11,0x6e,0x5e,0x29,0x6a,0x1,0x1d,0x82,0xa3,
            0x7c,0xc2,0xb0,0xc2,0x3a,0xb,0x7b,0x45,0xa9,// e
            0xb9,0xba,0xbb,0xbc,0xbd,0xbe,0xbf,
            0xc0,0xc1,0xc2,0xc3,0xc4,0xc5,0xc6,0xc7,0xc8,0xc9,0xca,0xcb,0xcc,0xcd,0xce,0xcf,
            0xd0,0xd1,0xd2,0xd3,0xd4,0xd5,0xd6,0xd7,0xd8,0xd9,0xda,0xdb,0xdc,0xdd,0xde,0xdf,
            0xe0,0xe1,0xe2,0xe3,0xe4,0xe5,0xe6,0xe7,0xe8,0xe9,0xea,//h
            0xfd,0xa1,0xae,0x1a,0x66,
            0xe1,0xeb,0xab,0xd,0xcc,0x99,0x85,0xa2,0xca,0xe6,0x11,0x52,0xfe,0xdd,0xfc,0xe2,
            0x6b,0x1e,0x76,0xb2,0x34,0xb3,0x5d,0xba,0x5,0x6f,0xc2,0xc4,0x19,0x89,0x56,0xac,
            0x66,0xe,0x8f,0xae,0x50,0x6f,0x20,0xf6,0xa4,0xb1,0x82,0x6b,0xd9,0x8b,0xa8,0xde,
            0x1a,0x51,0xcd,0xc0,0xe,0xfb,0x29,0x55,0x32,0x89,0x5a,0x6e,0xdd,0x81,0xab,0xb1,
