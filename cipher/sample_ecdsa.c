 ...
 * Description: drivers of sample_ecdsa
 * Author: zhaoguihong
 * Create: 2019-06-18
 */
#include <stdlib.h>
...
hi_void print_buffer(const char *string, const hi_u8 *input, hi_u32 length)
{
    hi_u32 i = 0;
...
#define ECDH_SECP384R1_P  "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEF"  \
                          "FFFFFFF0000000000000000FFFFFFFF"
#define ECDH_SECP384R1_A  "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFF" \
                          "FFFFFF0000000000000000FFFFFFFC"
#define ECDH_SECP384R1_B  "B3312FA7E23EE7E4988E056BE3F82D19181D9C6EFE8141120314088F5013875AC6" \
                          "56398D8A2ED19D2A85C8EDD3EC2AEF"
#define ECDH_SECP384R1_GX "AA87CA22BE8B05378EB1C71EF320AD746E1D3B628BA79B9859F741E082542A3855" \
                          "02F25DBF55296C3A545E3872760AB7"
#define ECDH_SECP384R1_GY "3617DE4A96262C6F5D9E98BF9292DC29F8F41DBD289A147CE9DA3113B5F0B8C00A" \
                          "60B1CE1D7E819D7A431D7C90EA0E5F"
#define ECDH_SECP384R1_N  "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC7634D81F4372DDF58" \
                          "1A0DB248B0A77AECEC196ACCC52973"
#define ECDH_SECP384R1_H                                                   1

#define ECDH_SECP512R1_P  "01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" \
                          "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"
#define ECDH_SECP512R1_A  "01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" \
                          "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC"
#define ECDH_SECP512R1_B  "0051953EB9618E1C9A1F929A21A0B68540EEA2DA725B99B315F3B8B489918EF109" \
                          "E156193951EC7E937B1652C0BD3BB1BF073573DF883D2C34F1EF451FD46B503F00"
#define ECDH_SECP512R1_GX "00C6858E06B70404E9CD9E3ECB662395B4429C648139053FB521F828AF606B4D3D" \
                          "BAA14B5E77EFE75928FE1DC127A2FFA8DE3348B3C1856A429BF97E7E31C2E5BD66"
#define ECDH_SECP512R1_GY "011839296A789A3BC0045C8A5FB42C7D1BD998F54449579B446817AFBD17273E66" \
                          "2C97EE72995EF42640C550B9013FAD0761353C7086A272C24088BE94769FD16650"
#define ECDH_SECP512R1_N  "01FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF" \
...
int main(int argc, char* argv[])
{
    ...
    hi_unf_cipher_ecdsa_sign_data ecdsa_sign_data;
    hi_unf_cipher_ecdsa_verify_data ecdsa_verify_data;
    ...
    const char *ecdh_gx[] = {ECDH_SECP192R1_GX, ECDH_SECP224R1_GX, ECDH_SECP256R1_GX,
                             ECDH_SECP384R1_GX, ECDH_SECP512R1_GX};
    const char *ecdh_gy[] = {ECDH_SECP192R1_GY, ECDH_SECP224R1_GY, ECDH_SECP256R1_GY,
                             ECDH_SECP384R1_GY, ECDH_SECP512R1_GY};
    const char *ecdh_n[] =  {ECDH_SECP192R1_N, ECDH_SECP224R1_N, ECDH_SECP256R1_N,
                             ECDH_SECP384R1_N, ECDH_SECP512R1_N};
    const hi_u32 ecdh_h[] =  {ECDH_SECP192R1_H, ECDH_SECP224R1_H, ECDH_SECP256R1_H,
                              ECDH_SECP384R1_H, ECDH_SECP512R1_H};
    ...
    buf = (hi_u8*)malloc(MAX_KEY_SIZE * 11);
    if(buf == HI_NULL)
    {
    ...
    r = ecc_param.n + MAX_KEY_SIZE;
    s = r + MAX_KEY_SIZE;
    priv_key = s + MAX_KEY_SIZE;
    pub_key_x = priv_key + MAX_KEY_SIZE;
    pub_key_y = pub_key_x + MAX_KEY_SIZE;
...
//       print_buffer("N", ecc_param.n, ecdh_sizes[i]);
        ...
        ret = hi_unf_cipher_ecc_gen_key(&ecc_param, HI_NULL, priv_key, pub_key_x, pub_key_y);
        if ( HI_SUCCESS != ret )
        {
            HI_ERR_CIPHER("hi_unf_cipher_ecc_gen_key B failed\n");
            return HI_FAILURE;
        }
    /*  print_buffer("priv_key", priv_key, ecdh_sizes[i]);
        print_buffer("pub_key_x", pub_key_x, ecdh_sizes[i]);
        print_buffer("pub_key_y", pub_key_y, ecdh_sizes[i]);*/
        ecdsa_sign_data.priv_key = priv_key;
        ecdsa_sign_data.hash_type = HI_UNF_CIPHER_HASH_TYPE_SHA256;
        ecdsa_sign_data.msg = msg;
        ecdsa_sign_data.msg_size = strlen((char*)msg);
        ecdsa_sign_data.sign_r = r;
        ecdsa_sign_data.sign_s =s;
        ecdsa_sign_data.sign_out_size = MAX_KEY_SIZE;
        ret = hi_unf_cipher_ecdsa_sign(&ecc_param, &ecdsa_sign_data);
        if ( HI_SUCCESS != ret )
        {
            HI_ERR_CIPHER("hi_unf_cipher_ecdsa_sign A failed, ret = 0x%x\n", -ret);
            return HI_FAILURE;
        }
    //  print_buffer("R", r, ecdh_sizes[i]);
    //  print_buffer("S", pu8, ecdh_sizes[i]);

        ecdsa_verify_data.pub_key_x = pub_key_x ;
        ecdsa_verify_data.pub_key_y = pub_key_y;
        ecdsa_verify_data.hash_type = HI_UNF_CIPHER_HASH_TYPE_SHA256;
        ecdsa_verify_data.msg = msg;
        ecdsa_verify_data.msg_size = strlen((char*)msg);
        ecdsa_verify_data.sign_r = r;
        ecdsa_verify_data.sign_s = s;
        ecdsa_verify_data.sign_out_size = MAX_KEY_SIZE;
        
        ret = hi_unf_cipher_ecdsa_verify(&ecc_param, &ecdsa_verify_data);
        if ( HI_SUCCESS != ret )
        {
            HI_ERR_CIPHER("hi_unf_cipher_ecdsa_verify B failed\n");
            return HI_FAILURE;
        }
    }
